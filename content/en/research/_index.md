...
<div class="paper-title">Parallel Readings, Fluid Meanings, and Local Imaginations: Cross-cultural Readings of Chinese Webnovels in Global Media Flows</div>
...
<p style="font-style: italic; margin-bottom: 30px; font-size: 0.95em;">
* The following selected projects were completed while working as Research Associate & Project Manager at NIPRSC, Communication University of China (July 2022 - July 2025).
</p>
...
<div class="paper-title">New Policy Communications for the Ministry of Education</div>
...
<div class="research-paper">
  <div class="research-content">
    ...
    <ul style="margin: 5px 0; padding-left: 20px;">
      ...
      <li>Conducted 30+ in-depth interviews with stakeholders to assess policy comprehension barriers</li>
      <li>Developed a standardized communication toolkit adopted by educational institutions nationwide</li>
    </ul>
  </div>
</div>
...
<div class="research-paper">
  <div class="research-content">
    ...
    <ul style="margin: 5px 0; padding-left: 20px;">
      ...
      <li>Created data visualizations showing communication patterns and public engagement trends</li>
      <li>Developed IP science communication framework adopted by government agencies</li>
    </ul>
  </div>
</div>
...
<div class="research-paper">
  <div class="research-content">
    ...
    <ul style="margin: 5px 0; padding-left: 20px;">
      ...
      <li>Developed guidelines integrating corporate technology, project implementation, and talent strategy</li>
      <li>Created standardized frameworks for brand release procedures</li>
    </ul>
  </div>
</div>

<div class="paper-title">Strategic Communication on Global Youth Values</div>
...
<div class="research-paper">
  <div class="research-content">
    ...
    <ul style="margin: 5px 0; padding-left: 20px;">
      ...
      <li>Conducted cross-cultural analysis combining surveys and interviews</li>
      <li>Developed frameworks for youth-oriented international communication</li>
    </ul>
  </div>
</div>
